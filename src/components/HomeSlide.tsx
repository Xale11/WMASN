...
const HomeSlide = () => {
  ...
  return (
    <Box w={"100%"} h={{base: "calc(100vh - 4em)", md: "calc(100vh - 5em)", lg: "calc(100vh - 6em)"}} display={"flex"} position={"relative"} backgroundImage={HomeImage2} backgroundSize={"cover"} backgroundRepeat={"no-repeat"} backgroundPosition={"center"} >
